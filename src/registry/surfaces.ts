...
export const PAGES: readonly Page[] = [
  ...
  page('TL-PAGE-ABOUT-001', 'About', '/about', 'TL-EXPERIENCE-SHELL-001', 'anonymous', 2, 'What Toothlogy is and the principles it runs on.', [], true),
  page('TL-PAGE-PRIVACY-POLICY-001', 'Privacy policy', '/privacy', 'TL-EXPERIENCE-SHELL-001', 'anonymous', 2, 'The privacy policy.', [], true),
  page('TL-PAGE-TERMS-001', 'Terms', '/terms', 'TL-EXPERIENCE-SHELL-001', 'anonymous', 2, 'Terms of use.', [], true),
