...
const PATHS = {
  ...
  // Marks the appearance control in the header, as the reference navbar does.
  sun: 'M12 5V3M12 21v-2M19 12h2M3 12h2M17 7l1.4-1.4M5.6 18.4 7 17M17 17l1.4 1.4M5.6 5.6 7 7M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Z',
